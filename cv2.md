...
Contamos con dos proyectos finalizados.
  ...
  > **Caro**<code class="code-aparte">Javascript</code>: Desarrollado para el *2do Concurso de desarrollo de Video Juegos en la Semana de Matemáticas Aplicadas y Computación*. Enfocado a PC, cuenta con una historia corta a través de 5 niveles cada uno siendo un minijuego.
